...
<img src="images/online-store-logo,-e-commerce-logo-design-template-0d53622234589ba0ac5d2cd780e5b9d4_screen.jpg" alt="">
     ...
     <section style="background: rgba(112, 112, 107, 0.438);margin-top: -5%;padding-bottom: 10%;">
     <section class="sect_5" style="background-image: linear-gradient(rgba(10,10,10,0.5),rgba(20,20,20,0.5),rgba(30,30,30,0.5));">
        <h1>Témoignages</h1>
        <div>
       ...
       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo similique temporibus mollitia, nam eligendi accusantium saepe delectus ex perspiciatis totam nulla iure qui unde possimus facere expedita ea, vitae consequatur?<p>
